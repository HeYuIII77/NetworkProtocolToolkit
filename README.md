...
工具支持 JPEG / RAW / 视频 多类型文件，支持并行复制、进度监控、日志记录，适合大规模素材备份与归档使用。
...
扫描源目录，递归获取所有符合条件的媒体文件

统计文件总数与总体字节数

预创建目标目录结构（避免并行复制时的目录竞态）
